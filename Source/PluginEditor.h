...
private:
    ...
    // Controls
    // Added kOutput
    std::unique_ptr<Knob> kThresh, kRatio, kKnee, kAttack, kRelease, kMakeup, kMix, kOutput;
    ...
    juce::ToggleButton bSatAutoGain; // NEW
    ...
    std::unique_ptr<SliderAttachment> aThresh, aRatio, aKnee, aAttack, aRelease, aMakeup, aMix, aOutput;
    ...
    std::unique_ptr<ComboBoxAttachment> aAutoRel, aThrust, aCtrlMode, aTpMode, aFluxMode, aSatMode, aSignalFlow;
    std::unique_ptr<ButtonAttachment> aTurbo, aSatAutoGain;
